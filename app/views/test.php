...
<head>
    ...
    <title>Statti - Responsive Bootstrap Animated Template</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/surfme.css" />
    ...
    <ul class="slides-container">
        ...
        <li><a href="#"><img src="img/slide1.jpg" alt="Photo" /></a>
            <div class="slides-detail">
                ...
                <span class="lead">Cras justo odio, dapibus ac <strong>facilisis in</strong>, egestas eget</span></div>
        </li>
        ...
        <li><a href="#"><img src="img/slide2.jpg" alt="Photo" /></a>
            <div class="slides-detail">
                ...
                <span class="lead">Justo odio, dapibus ac <strong>quam in</strong>, egestas eget</span></div>
        </li>
